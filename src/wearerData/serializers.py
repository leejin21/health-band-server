...
class WearerDataSerializer(serializers.Serializer):
    ...
    tempHumid = serializers.CharField(max_length=50)
    gyro = serializers.CharField(max_length=50)
    accel = serializers.CharField(max_length=50)
    heartRate = serializers.CharField(max_length=50)
    sound = serializers.CharField(max_length=50)
    vibrate = serializers.CharField(max_length=50)
